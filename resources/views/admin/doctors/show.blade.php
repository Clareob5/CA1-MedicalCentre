        ...
        <div class="col-md-10 col-md-offset-2">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.doctors.index')}}" class="btn btn-outline-dark">Back</a>
                    <a href="{{ route('admin.doctors.edit', $doctor->id)}}" class="btn btn-outline-secondary">Edit</a>
